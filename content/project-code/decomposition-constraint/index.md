    ...
    content:
      text: |-
        ...
        <div style="background: #1a202c; border: 1px solid #4a5568; border-radius: 8px; padding: 2rem; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.3); transition: all 0.2s ease;">
          ...
          <a href="/data/project/cvlp/cvlp1.pdf" target="_blank" style="display: inline-flex; align-items: center; color: #90cdf4; text-decoration: none; font-weight: 600; font-size: 0.95rem; transition: color 0.2s ease;">
        ...
        <div style="background: #1a202c; border: 1px solid #4a5568; border-radius: 8px; padding: 2rem; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.3); transition: all 0.2s ease;">
          ...
          <a href="/data/project/cvlp/cvlp2.pdf" target="_blank" style="display: inline-flex; align-items: center; color: #90cdf4; text-decoration: none; font-weight: 600; font-size: 0.95rem; transition: color 0.2s ease;">
            Access PDF Document <span style="margin-left: 0.5rem; font-size: 1rem;">→</span>
          </a>
        </div>
        ...
        <a href="/data/project/cvlp/cvlp3.py" download style="display: inline-flex; align-items: center; gap: 0.5rem; color: #818cf8; text-decoration: none; font-weight: 500; font-size: 0.95rem; padding: 0.5rem 1rem; border: 1px solid rgba(129, 140, 248, 0.3); border-radius: 6px; transition: all 0.2s;">
